...
export default function Header() {
  ...
  return (
    <>
      <header className="bg-[#002b5c] text-white py-4 px-6 md:px-12 lg:sticky lg:top-0 z-50 shadow-md">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden lg:flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebd5e] text-white px-4 py-2 rounded-md font-semibold text-sm transition-all shadow-sm"
            >
            ...
            <button
              ...
              className="hidden lg:flex items-center gap-2 bg-white hover:bg-gray-100 text-[#002b5c] px-4 py-2 rounded-md font-semibold text-sm transition-all border border-[#002b5c] shadow-sm"
            >
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
