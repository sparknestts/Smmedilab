        ...
        <div className="flex flex-col lg:flex-row lg:items-start gap-10 lg:gap-16">
          <div className="flex-1 space-y-5 max-w-2xl">
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              Explore our comprehensive catalog of laboratory services — from
              routine screenings to advanced specialized diagnostics. Every test
              is performed with surgical precision and delivered with the clarity
              you deserve.
            </p>
          </div>
          ...
          <div className="flex-1 w-full lg:max-w-xl">
            <form
              className="flex items-center bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden"
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
            {filterCategories.map((category) => (
              <button
                ...
                className={`shrink-0 px-4 md:px-5 py-2.5 rounded-full text-sm font-semibold transition-all ${
