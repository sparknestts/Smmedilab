                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4 text-blue-50/80 font-medium">
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:info@smmedilab.com">Info@smmedilab.com</a>
                            </li>
                            <li className="flex items-center gap-3">
                                <svg className="w-5 h-5 text-[#ffffff]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <a href="tel:+94777791229">+94 77 779 1229</a>
                            </li>
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <a href="https://www.instagram.com/smmedilabsjaffna?igsh=MTUwYng2NDFrMWJzaw==" target="_blank" rel="noopener noreferrer" title="Instagram" className="bg-white/10 p-2.5 rounded-full hover:bg-[#002b5c]/20 transition-all cursor-pointer">
                            ...
                            <ShareButton title="Share link to friends" className="bg-white/10 p-2.5 rounded-full hover:bg-[#002b5c]/20 transition-all cursor-pointer">
                                <svg className="w-5 h-5 text-[#ffffff]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
