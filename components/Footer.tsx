    ...
    return (
        <footer className="bg-[#FFFFFF] text-white pt-20 pb-8 px-6 md:px-12 lg:px-24 border-t border-white/5">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="md:hidden bg-white -mx-6 -mb-8 px-6 py-10">
                    {/* Brand & About */}
                    <div className="text-center mb-8">
                        <h3 className="text-2xl font-black uppercase tracking-widest text-[#1E3A8A] mb-4">SM Medical Lab</h3>
                    ...
                    <div className="space-y-3 mb-6">
                        <h4 className="text-center text-base font-bold uppercase tracking-widest text-[#1E3A8A]">Services</h4>
                        <ul className="space-y-2.5 text-[#64748B] text-sm text-center">
                            <li><a href="/services" className="hover:text-[#1E3A8A] transition-colors">Blood Tests</a></li>
                            <li><a href="/services" className="hover:text-[#1E3A8A] transition-colors">DNA Analysis</a></li>
                            <li><a href="/services" className="hover:text-[#1E3A8A] transition-colors">Corporate Wellness</a></li>
                            <li><a href="/services" className="hover:text-[#1E3A8A] transition-colors">Health Packages</a></li>
                        </ul>
                    </div>

                    {/* Company Section */}
                    <div className="space-y-3 mb-6">
                        <h4 className="text-center text-base font-bold uppercase tracking-widest text-[#1E3A8A]">Company</h4>
                        <ul className="space-y-2.5 text-[#64748B] text-sm text-center">
                            <li><a href="/about" className="hover:text-[#1E3A8A] transition-colors">About Us</a></li>
                            <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Career</a></li>
                            <li><a href="/contact" className="hover:text-[#1E3A8A] transition-colors">Patient Portal</a></li>
                            <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">FAQ</a></li>
                        </ul>
                    </div>

                    {/* Contact Section */}
                    <div className="space-y-3 mb-6">
                        <h4 className="text-center text-base font-bold uppercase tracking-widest text-[#1E3A8A]">Contact</h4>
                        <ul className="space-y-2.5 text-[#64748B] text-sm text-center">
                    ...
                    <div className="flex items-center justify-center gap-3 pt-2">
                        <a href="#" className="bg-[#002b5c]/10 p-2.5 rounded-full hover:bg-[#002b5c]/20 transition-all">
                            <svg className="w-5 h-5 text-[#002b5c]" fill="currentColor" viewBox="0 0 24 24">
