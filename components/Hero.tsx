            ...
            <div className="flex-1 max-w-2xl space-y-8 animate-in fade-in slide-in-from-left duration-1000">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4 pt-4">
                    <button
                        ...
                        className="flex items-center gap-2 bg-[#008a3e] hover:bg-[#007032] text-white px-8 py-4 rounded-lg font-bold text-lg transition-all shadow-lg hover:-translate-y-1"
                    >
