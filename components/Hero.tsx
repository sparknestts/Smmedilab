    ...
    return (
        <main className="flex-grow flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 lg:px-24 py-12 md:py-20 lg:py-24 gap-12 overflow-hidden bg-white">
            ...
            <div className="flex-1 max-w-2xl space-y-8 animate-in fade-in slide-in-from-left duration-1000">
                <div className="inline-block bg-[#dbffeb] text-[#28a745] px-4 py-1 rounded-md text-xs font-bold uppercase tracking-wider">
                    Certified Precision
                </div>

                <h1 className="text-4xl md:text-6xl lg:text-[72px] font-black text-[#002b5c] leading-[1.1] tracking-tight">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4 pt-4">
                    <a href="#" className="flex items-center gap-2 bg-[#008a3e] hover:bg-[#007032] text-white px-8 py-4 rounded-lg font-bold text-lg transition-all shadow-lg hover:-translate-y-1">
                    ...
                    <a href="#" className="bg-gray-100 hover:bg-gray-200 text-gray-800 px-8 py-4 rounded-lg font-bold text-lg transition-all border border-gray-200">
                        View All Packages
                    </a>
                </div>
            </div>
          ...
          <div className="relative z-10 bg-gray-50 rounded-[40px] p-2 md:p-4 shadow-2xl overflow-hidden group">
          ...
          {/* ISO Card */}
          <div className="absolute -bottom-6 -left-6 md:-left-12 bg-white p-4 md:p-6 rounded-2xl shadow-2xl z-20 flex items-center gap-4 animate-bounce-slow border border-gray-50">
            <div className="bg-[#dbffeb] p-3 rounded-full flex items-center justify-center">
            ...
            <div>
              <div className="font-black text-gray-900 text-lg leading-tight">ISO Accredited</div>
              <div className="text-gray-500 text-sm font-medium">Global Standard Lab</div>
            </div>
          </div>
        </div>
        </main>
