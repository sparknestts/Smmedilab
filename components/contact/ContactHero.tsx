      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          <div className="flex-1 space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 border-2 border-[#4a90e2] text-[#002b5c] font-bold px-6 py-3.5 rounded-xl hover:bg-[#f0f4ff] transition-colors"
              >
                <svg
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1ebd5e] text-white font-bold px-6 py-3.5 rounded-xl transition-colors"
              >
          ...
          <div className="flex-1 w-full">
            <div className="relative rounded-[32px] md:rounded-[40px] overflow-hidden shadow-2xl aspect-square max-w-lg mx-auto lg:max-w-none">
              <Image
                src="/contact-img.svg"
