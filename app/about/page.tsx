            ...
            <main className="flex-grow">
                    ...
                    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="flex-1 relative animate-in fade-in slide-in-from-right duration-1000">
                            ...
                            <div className="relative">
                                ...
                                <div
                                    id="heritage-card"
                                    className="absolute bottom-8 left-8 right-8 md:bottom-12 md:left-[-40px] md:right-auto md:w-[360px] bg-white p-10 rounded-[32px] shadow-2xl animate-bounce-slow z-20 border border-gray-50"
                                >
                                    <p className="text-[#002b5c] text-xl md:text-2xl font-black leading-tight italic">
                ...
                <section className="py-24 bg-slate-50 px-6 md:px-12 lg:px-24">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        {/* Our Mission Card */}
                        <div className="bg-white p-10 md:p-14 rounded-[48px] shadow-sm hover:shadow-xl transition-all duration-500 border border-slate-100 group">
                        ...
                        {/* Our Vision Card */}
                        <div className="bg-[#002b5c] p-10 md:p-14 rounded-[48px] shadow-2xl hover:shadow-blue-900/20 transition-all duration-500 group border border-[#003d7e]">
                ...
                <section className="py-24 bg-white px-6 md:px-12 lg:px-24">
                    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
                        ...
                        <div className="lg:flex-1 space-y-12">
                            ...
                            <div className="space-y-12 relative before:absolute before:left-2 before:top-2 before:bottom-2 before:w-[2px] before:bg-blue-100">
                                {/* 1998 */}
                                <div className="relative pl-12 group">
                                    ...
                                    <div className="space-y-2">
                                        <div className="text-[#4a90e2] font-black text-sm tracking-widest">1998</div>
                                        <h3 className="text-2xl font-bold text-gray-900">Foundation</h3>
                                        <p className="text-gray-500 leading-relaxed max-w-lg font-medium">
                                ...
                                <div className="relative pl-12 group">
                                    <div className="absolute left-0 top-1 w-4 h-4 rounded-full bg-[#002b5c] border-4 border-white shadow-sm z-10 group-hover:scale-125 transition-transform"></div>
                                    <div className="space-y-2">
                                        <div className="text-[#4a90e2] font-black text-sm tracking-widest">2010</div>
                                ...
                                <div className="relative pl-12 group">
                                    <div className="absolute left-0 top-1 w-4 h-4 rounded-full bg-[#002b5c] border-4 border-white shadow-sm z-10 group-hover:scale-125 transition-transform"></div>
                                    <div className="space-y-2">
                                        <div className="text-[#4a90e2] font-black text-sm tracking-widest">2023</div>
                                        <h3 className="text-2xl font-bold text-gray-900">Digital Evolution</h3>
                                        <p className="text-gray-500 leading-relaxed max-w-lg font-medium">
                        ...
                        <div className="lg:flex-1 flex flex-col justify-between">
                            {/* Accreditation Box */}
                            <div className="bg-slate-100/70 p-8 md:p-10 rounded-[40px] space-y-8">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        <h4 className="text-2xl font-bold text-gray-900 leading-tight">Accredited Excellence</h4>
                                        <p className="text-gray-400 font-medium">Certified by global medical boards</p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <div key={idx} className="bg-white p-5 rounded-[24px] flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div className="relative group rounded-[40px] overflow-hidden shadow-2xl h-[246px] mt-8">
                                <Image
                                    src="/img5.png"
                    ...
                    <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-8 items-center justify-items-center">
                            ...
                            <div className="text-center space-y-3">
                                <div className="text-4xl lg:text-5xl font-black text-[#002b5c] tracking-tight">
                ...
                <section className="py-32 bg-white px-6 md:px-12 lg:px-24 overflow-hidden">
                    <div className="max-w-5xl mx-auto text-center space-y-16">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -top-12 -left-4 md:-left-12 text-[#002b5c]/5 text-[160px] font-serif leading-none select-none pointer-events-none">
                                &ldquo;
                            </div>
                            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] tracking-tight relative z-10">
